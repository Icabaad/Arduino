...
//char sensorId7[] = "HydroHeat_Power";
//char sensorId8[] = "Lights_and_Power";
char sensorId9[] = "Total_Power";
char sensorId10[] = "Xbee1_Battery";
char sensorId11[] = "Xbee1_Solar";
...
XivelyDatastream datastreams[] = {
  ...
  //XivelyDatastream(sensorId7, strlen(sensorId7), DATASTREAM_INT),
  //XivelyDatastream(sensorId8, strlen(sensorId8), DATASTREAM_INT),  
  XivelyDatastream(sensorId9, strlen(sensorId9), DATASTREAM_INT),
  XivelyDatastream(sensorId10, strlen(sensorId10), DATASTREAM_FLOAT),
  XivelyDatastream(sensorId11, strlen(sensorId11), DATASTREAM_FLOAT),
...
XivelyFeed feed(1177751918, datastreams, 10 /* number of datastreams */);
...
*/
  ...
  if (xbee.getResponse().isAvailable()) {
    if (xbee.getResponse().getApiId() == ZB_IO_SAMPLE_RESPONSE) {
      ...
      datastreams[10].setFloat(xbee1battery);

      int vReading2 = (ioSample.getAnalog(2));
      float xbee1solar = vReading2 * 9 / 1024;      
      // voltage /= 1024.0; 
      Serial.print(xbee1solar); 
      Serial.println(" Xbee Solar");
      datastreams[11].setFloat(xbee1solar);
